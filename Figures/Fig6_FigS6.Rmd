...
MCMCs <- list()
MCMCs$day2 <- BASiCS_LoadChain("day2", chains.path)
MCMCs$day4 <- BASiCS_LoadChain("day4", chains.path)
MCMCs$day7 <- BASiCS_LoadChain("day7", chains.path)

p2 <- BASiCS_diagPlot(MCMCs$day2)
p4 <- BASiCS_diagPlot(MCMCs$day4)
p7 <- BASiCS_diagPlot(MCMCs$day7)

library(cowplot)
plot_grid(p2, p4, p7, ncol = 3)

ess2 <- BASiCS_effectiveSize(MCMCs$day2, Param = "mu")
ess4 <- BASiCS_effectiveSize(MCMCs$day4, Param = "mu")
ess7 <- BASiCS_effectiveSize(MCMCs$day7, Param = "mu")

plot(MCMCs$day2, Param = "mu", Gene = which(ess2 < 5)[1])
plot(MCMCs$day4, Param = "mu", Gene = which(ess4 < 5)[1])
plot(MCMCs$day7, Param = "mu", Gene = which(ess7 < 5)[1])
...
Test.day2_vs_day4 <- BASiCS_TestDE(Chain1 = MCMCs$day4, Chain2 = MCMCs$day2, 
                                   ...
                                   Plot = TRUE, PlotOffset = FALSE, OrderVariable = "GeneName",
                                   EDFR_M = 0.1, EFDR_D = 0.1, EFDR_R = 0.1)
